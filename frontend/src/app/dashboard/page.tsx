  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Here's an overview of your workspace.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {teams.length === 0 ? (
            <p className="text-gray-500">You don't have any teams yet. Create one to get started!</p>
          ) : (
      ...
      {currentTeam && (
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {tasks.length === 0 ? (
            <p className="text-gray-500">This team doesn't have any tasks yet.</p>
          ) : (
